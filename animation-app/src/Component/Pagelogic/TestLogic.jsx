...
const TestLogic = () => {
    ...
    useEffect(() => {
        ...
        // Зупиняємо анімацію при знаходженні правильної відповіді
        if (isCorrectTest3) {
            anime.remove('.svg-path3'); // Зупиняємо анімацію
            ...
            // Анімація буде виконуватись лише у випадку, якщо не знайдено правильну відповідь
            ...
            anime({
                targets: '.svg-path3', // Замініть '.svg-path' на ваш селектор для елементу SVG
                translateY: [
                    { value: 0, duration: 0 }, // Початкове значення
                    { value: -15, duration: 1000, easing: 'easeInOutQuad' }, // Кінцеве значення
                    { value: 0, duration: 1000, easing: 'easeInOutQuad' } // Повернення до початкового значення
                ],
                loop: true // Повторювати анімацію
            });
        }
