...
const Main = () => {
    ...
    useEffect(() => {
        // Виконати анімацію при монтуванні компоненти
        ...
        // Повернути функцію очищення для зупинки анімації при розмонтуванні компоненти
        return () => svgAnimation.pause();
    }, []);
...
69 64 90 50 90 -3 0 -18 -13 -32 -29z"  stroke="black" strokeWidth="7" fill='none' />
...
-39 -2 3 11 20 31 37 38 33 63 34 45 2z"  stroke="black" strokeWidth="7" fill='none'/>
...
4 -16 -10 -12 23 9 63 29 57 33 79 18 85 -7 3 -22 0 -33 -5z"  stroke="black" strokeWidth="7" fill='none'/>
...
-32 -87 -5 -87 17 0 18 3 9 18 -8 13 -6 28 10 65 31 72 26 96 -14 75z"  stroke="black" strokeWidth="7" fill='none'/>
                                <path className="path" d="M956 378 c-9 -12 -13 -24 -11 -27 6 -5 45 29 45 41 0 15 -19 8 -34
-14z"  stroke="black" strokeWidth="7" fill='none'/>
...
76 77 10 0 22 -10 27 -22z"  stroke="black" strokeWidth="7" fill='none'/>
...
-8 6 14 -18 56 -31 56 -4 0 -20 -8 -37 -19z"  stroke="black" strokeWidth="7" fill='none'/>
...
-76 -51 -53 -86 -65 -95 -32 -6 23 58 110 93 128 33 17 44 12 48 -20z"  stroke="black" strokeWidth="7" fill='none'/>
...
49 12z"  stroke="black" strokeWidth="7" fill='none'/>
...
54 99 10 -2 19 -11 21 -20z"  stroke="black" strokeWidth="7" fill='none'/>
